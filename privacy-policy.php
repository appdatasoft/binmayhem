...
<!-- MAIN -->
    <main role="main">
      <!-- Content -->
      <article>
        <header class="section-1 background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-50 text-thin text-line-height-1">Privacy Policy</h1>
        </header>
...
<div>
<br>
<h4>SECTION 1 - WHAT DO WE DO WITH YOUR INFORMATION?</h4></div>
<div></div>
...
<div></div>
<div>
<br>How do I withdraw my consent?</div>
<div></div>
<div>If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at anytime, by contacting us at info@binmayhem.com.</div>
<div></div>
<div>

<br>
<h4>SECTION 3 - DISCLOSURE</h4></div>
<div></div>
...
<div>
<br>
<h4>SECTION 5 - THIRD-PARTY SERVICES</h4></div>
<div></div>
<div>
<br>In general, the third-party providers used by us will only collect, use and disclose your information to the extent necessary to allow them to perform the services they provide to us.</div>
<div></div>
...
<div></div>
<div>
<br><h4>SECTION 6 - SECURITY</h4></div>
<div></div>
...
<div></div>
<div></div>
<div><h4>SECTION 7 - AGE OF CONSENT</h4></div>
<div></div>
...
<div></div>
<div>
<br><h4>SECTION 8 - CHANGES TO THIS PRIVACY POLICY</h4></div>
<div></div>
...
<div></div>
<div>
<br><h4>QUESTIONS AND CONTACT INFORMATION</h4></div>
<div></div>
<div>If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information contact our Privacy Compliance Officer at info@binmayhem.com.</div>
</div>
        </div>
      </div>
    </div>
